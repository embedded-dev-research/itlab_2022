...
class Color {
 ...
 public:
  Color(const unsigned char& a = 0, const unsigned char& b = 0,
  ...
  void set_color(const unsigned char& a = 0, const unsigned char& b = 0,
                 const unsigned char& c = 0, const unsigned char& d = 0);
...
template <layout Layout>
Color<Layout>::Color(const unsigned char& a, const unsigned char& b,
...
template <>
void Color<layout::rgb>::set_color(const unsigned char& a,
...
template <>
void Color<layout::bgr>::set_color(const unsigned char& a,
                                   const unsigned char& b,
                                   const unsigned char& c,
                                   const unsigned char& d) {
  components[0] = c;
